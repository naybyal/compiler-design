...
static const char *const yytname[] =
{
  ...
  "MINUS", "MUL", "DIV", "LPAREN", "RPAREN", "$accept", "expression",
...
#line 30 "calc.y"
                                  { result = (yyvsp[-2].num) + (yyvsp[0].num); }
#line 1147 "y.tab.c"
    break;
...
#line 37 "calc.y"
                                   { if ((yyvsp[0].num) == 0) { yyerror("Division by zero!"); exit(1); } else { result = (yyvsp[-2].num) / (yyvsp[0].num); } }
#line 1171 "y.tab.c"
    break;
